module Interpreter.Eval.ExecutionEngine (interpret) where

import Control.Monad ( (>=>), foldM )
import Interpreter.Eval.Utils.StackUtils (pushValue, popValue, dupValue, swapValue)
import Interpreter.Eval.Utils.ProgramUtils (assignValue, assignFunc, extractTop, nextToken, withProgram)
